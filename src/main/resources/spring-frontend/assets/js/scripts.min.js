                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            case'changedate':
                                if (e.type === 'change') {
                                    ...
                                    if (!$this.hasClass('form-input_date_uninit')) {
                                        ...
                                        getData('/books/recent/changedate', {
                            ...
                            case'genre':
                                ...
                                break;
                            case'parentGenre':
                                getData('/books/parentGenre/' + $this.data('refreshid'), {
                                    offset: function (){
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
